...
export class LoginScreen extends BaseScreen {
    private usernameSelector = AndroidSelectors.usernameSelector;
    private passwordSelector = AndroidSelectors.passwordSelector;
    private loginButtonSelector = AndroidSelectors.loginButtonSelector;
    private loginBotSelector = AndroidSelectors.loginBotSelector;
