...
export class CheckoutInformationScreen extends BaseScreen {
    private checkoutInformationTitleSelector = AndroidSelectors.checkoutInformationTitleSelector;
    private firstNameFieldSelector = AndroidSelectors.firstNameFieldSelector;
    private lastNameFieldSelector = AndroidSelectors.lastNameFieldSelector;
    private zipCodeFieldSelector = AndroidSelectors.zipCodeFieldSelector;
    private cancelButtonSelector = AndroidSelectors.cancelButtonSelector;
    private continueButtonSelector = AndroidSelectors.continueButtonSelector;
